...
// CBRService реализует интеграцию с ЦБ РФ для получения ключевой ставки
type CBRService struct{}

// NewCBRService создает новый сервис для работы с ЦБ РФ
...
func (s *CBRService) GetCentralBankRate() (float64, error) {
	...
	// Добавление маржи банка (например, +5%)
	return rate + 5, nil
}
